...
export class LinkedinPersonalAgent extends BaseAgent {
  constructor() {
    super('linkedin_personal');
  }

  async generate(answers, db, client) {
    const steps = [];
    ...
    const basePromptText = PERSONAL_LINKEDIN_PROMPT(answers);
